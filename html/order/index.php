                ...
                if (stockQuantity > 0) {
                    ...
                    row.innerHTML = `<td>${productName}</td>
                                     ...
                                     <td class="quantity-column">
                                         <button class="btn btn-outline-success quantity-button" onclick="changeQuantity(this, -1, ${productId}, ${stockQuantity})">－</button>
                                         <span>1個</span>
                                         <button class="btn btn-outline-success quantity-button" onclick="changeQuantity(this, 1, ${productId}, ${stockQuantity})">＋</button>
                                     </td>
                                     <td class="delete-column">
                                         <button class="btn btn-outline-danger" onclick="removeFromCart(this, ${price}, ${productId})" class="btn btn-danger">削除</button>
                                     </td>`;
